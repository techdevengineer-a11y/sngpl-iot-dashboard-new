      ...
      <div className="flex flex-col space-y-4 pb-8">
        ...
        <div className="grid grid-cols-6 gap-3">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl p-5 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]"
          >
            <div className="flex items-center justify-between mb-3">
              <span className="text-white text-xs font-semibold uppercase tracking-wide">Total SMS</span>
              <div className="p-2 bg-white/20 backdrop-blur-sm rounded-lg">
                <Activity className="w-5 h-5 text-white" />
              </div>
            </div>
            <div className="text-4xl font-bold text-white drop-shadow-md">{totalDevices}</div>
            <div className="text-xs text-blue-100 mt-2 font-medium">Devices</div>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl p-5 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]"
          >
            <div className="flex items-center justify-between mb-3">
              <span className="text-white text-xs font-semibold uppercase tracking-wide">Online</span>
              <div className="p-2 bg-white/20 backdrop-blur-sm rounded-lg">
                <Wifi className="w-5 h-5 text-white" />
              </div>
            </div>
            <div className="text-4xl font-bold text-white drop-shadow-md">{onlineDevices}</div>
            <div className="text-xs text-green-100 mt-2 font-medium">{((onlineDevices / totalDevices) * 100).toFixed(1)}%</div>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-red-500 to-rose-500 rounded-xl p-5 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]"
          >
            <div className="flex items-center justify-between mb-3">
              <span className="text-white text-xs font-semibold uppercase tracking-wide">Offline</span>
              <div className="p-2 bg-white/20 backdrop-blur-sm rounded-lg">
                <WifiOff className="w-5 h-5 text-white" />
              </div>
            </div>
            <div className="text-4xl font-bold text-white drop-shadow-md">{offlineDevices}</div>
            <div className="text-xs text-red-100 mt-2 font-medium">{((offlineDevices / totalDevices) * 100).toFixed(1)}%</div>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-yellow-500 to-orange-500 rounded-xl p-5 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]"
          >
            <div className="flex items-center justify-between mb-3">
              <span className="text-white text-xs font-semibold uppercase tracking-wide">Alerts</span>
              <div className="p-2 bg-white/20 backdrop-blur-sm rounded-lg">
                <AlertTriangle className="w-5 h-5 text-white" />
              </div>
            </div>
            <div className="text-4xl font-bold text-white drop-shadow-md">{totalAlerts}</div>
            <div className="text-xs text-yellow-100 mt-2 font-medium">Active</div>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl p-5 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]"
          >
            <div className="flex items-center justify-between mb-3">
              <span className="text-white text-xs font-semibold uppercase tracking-wide">Started</span>
              <div className="p-2 bg-white/20 backdrop-blur-sm rounded-lg">
                <Clock className="w-5 h-5 text-white" />
              </div>
            </div>
            <div className="text-lg font-bold text-white drop-shadow-md">{dataStartTime.toLocaleTimeString()}</div>
            <div className="text-xs text-purple-100 mt-2 font-medium">{dataStartTime.toLocaleDateString()}</div>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="flex-1 bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-slate-200"
        >
          {/* Chart Header */}
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 text-sm mt-2 ml-1">Real-time aggregated gas flow monitoring</p>
            </div>
          ...
          <div className="grid grid-cols-4 gap-4 mb-6">
            <div className="bg-gradient-to-br from-cyan-500 to-blue-500 rounded-xl p-5 shadow-md hover:shadow-lg transition-all duration-300">
              <div className="text-xs text-white/90 mb-2 font-semibold uppercase tracking-wide">Current Flow</div>
              <div className="text-3xl font-bold text-white drop-shadow-md">{currentFlow.toFixed(1)}</div>
              <div className="text-xs text-cyan-100 mt-2 font-medium">MCF/day</div>
            </div>

            <div className="bg-gradient-to-br from-green-500 to-teal-500 rounded-xl p-5 shadow-md hover:shadow-lg transition-all duration-300">
              <div className="text-xs text-white/90 mb-2 font-semibold uppercase tracking-wide">Peak Flow</div>
              <div className="text-3xl font-bold text-white drop-shadow-md">{getPeakFlow().toFixed(1)}</div>
              <div className="text-xs text-green-100 mt-2 font-medium">MCF/day</div>
            </div>

            <div className="bg-gradient-to-br from-purple-500 to-indigo-500 rounded-xl p-5 shadow-md hover:shadow-lg transition-all duration-300">
              <div className="text-xs text-white/90 mb-2 font-semibold uppercase tracking-wide">Duration</div>
              <div className="text-2xl font-bold text-white drop-shadow-md">{getDuration()}</div>
              <div className="text-xs text-purple-100 mt-2 font-medium">Running Time</div>
            </div>

            <div className="bg-gradient-to-br from-yellow-500 to-amber-500 rounded-xl p-5 shadow-md hover:shadow-lg transition-all duration-300">
              <div className="text-xs text-white/90 mb-2 font-semibold uppercase tracking-wide">Last Update</div>
              <div className="text-2xl font-bold text-white drop-shadow-md">{getTimeAgo()}</div>
              <div className="text-xs text-yellow-100 mt-2 font-medium">{historicalFlow.length} points</div>
            </div>
          </div>
